...
Public Class MainFrm
    ...
    Sub ReceiveSerialData(ByVal Data As String)
        ...
        '//found extruder temp
        If InStr(Data, "T:") > 0 Then
            If m105 = True Then
                m105 = False
                okToSend = True
            End If
            lblETemp.Text = Split(Data, "T:")(1) & "C"
        End If
        'found bed temp
        If InStr(Data, "B:") > 0 Then
            ...
            okToSend = True
            'End If
            lblBtemp.Text = Split(Data, "B:")(1) & "C"
        End If
        '//found ok
    ...
    Private Sub startSending()
        ...
        For i = ArrayHolder To UBound(lineArray)
            ...
            If lineArray(i) <> vbNullString Then
                ...
                End If
                If InStr(lineArray(i), "M105") > 0 Then m105 = True
                txtLog.Text &= "Sending: " & lineArray(i) & vbCrLf
